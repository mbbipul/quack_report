...
//
            ...
            JSONArray jsonResArray = baseJsonObject.getJSONArray("features");
            //            Loop through each feature in the array
            for(int i=0; i < jsonResArray.length(); i++){

                //Get earthquake JSONObject at position i
                JSONObject currentEarthquake = jsonResArray.getJSONObject(i);
                //Get “properties” JSONObject
                JSONObject properties = currentEarthquake.getJSONObject("properties");
                // Extract “mag” for magnitude
                String magnititude = properties.getString("mag");
                ...
                Earthquake earthquake = new Earthquake(magnititude,place,time);
